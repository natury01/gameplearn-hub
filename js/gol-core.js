/* GameOnLearn Hub — แกนกลางเชื่อม Supabase (fetch ตรง สไตล์เดียวกับเกมกาญจนบุรี)
 * มาตรฐาน: 00_PLATFORM_AGREEMENT.md v1.0 — anon key + RLS/RPC เท่านั้น */
(function () {
  const CFG = window.GOL_CONFIG;
  const SKEY = 'gol_hub_sess';
  ...
  window.GOL = { loadSess, ensure, session: () => sess, api, get, rpc, countRows,
