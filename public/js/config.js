...
window.GP_CONFIG = {
  ...
  HUB_VERSION: 'V.1.6.40',
  /* แสตมป์วันสร้างจริง (อ่านนาฬิกา ไม่กะล่วงหน้า) — .35 แสตมป์ 0902 คลาดวันจริงไปหนึ่งวัน
     อย่าใช้คู่นี้เรียงลำดับรุ่น ให้ดู HUB_VERSION เท่านั้น */
  HUB_BUILD: '2569.0908',
